    ...
    try {
      const query = `
        SELECT
          ...
          ad.demand_gen_carousel_ad.carousel_cards.asset,
          ...
          ad.demand_gen_multi_asset_ad.logo_images.asset,
          ad.demand_gen_multi_asset_ad.marketing_images,
          ad.demand_gen_multi_asset_ad.marketing_images.asset,
          ad.demand_gen_multi_asset_ad.portrait_marketing_images,
          ad.demand_gen_multi_asset_ad.portrait_marketing_images.asset,
          ad.demand_gen_multi_asset_ad.square_marketing_images,
          ad.demand_gen_multi_asset_ad.square_marketing_images.asset,
          ...
          ad.demand_gen_video_responsive_ad.call_to_actions.asset,
          ...
          ad.demand_gen_video_responsive_ad.logo_images.asset,
          ad.demand_gen_video_responsive_ad.long_headlines,
          ad.demand_gen_video_responsive_ad.videos,
          ad.demand_gen_video_responsive_ad.videos.asset,
      ...
      return response.map(({ ad }) => ({
        ...
        app_ad_html5_media_bundles_asset: ad.app_ad.html5_media_bundles?.map(bundle => bundle.asset),
        app_ad_images: ad.app_ad.images?.map(image => image.asset),
        app_ad_images_asset: ad.app_ad.images?.map(image => image.asset),
        ...
        app_ad_youtube_videos_asset: ad.app_ad.youtube_videos.map(video => video.asset),
        ...
        app_engagement_ad_images_asset: ad.app_engagement_ad.images?.map(image => image.asset),
        app_engagement_ad_videos: ad.app_engagement_ad.videos?.map(video => video.asset),
        app_engagement_ad_videos_asset: ad.app_engagement_ad.videos?.map(video => video.asset),
        ...
        demand_gen_carousel_ad_carousel_cards_asset: ad.demand_gen_carousel_ad.carousel_cards?.map(card => card.asset),
        ...
        demand_gen_carousel_ad_logo_image_asset: ad.demand_gen_carousel_ad.logo_image.asset,
        ...
        demand_gen_multi_asset_ad_logo_images_asset: ad.demand_gen_multi_asset_ad.logo_images?.map(image => image.asset),
        demand_gen_multi_asset_ad_marketing_images: ad.demand_gen_multi_asset_ad.marketing_images?.map(image => image.asset),
        demand_gen_multi_asset_ad_marketing_images_asset: ad.demand_gen_multi_asset_ad.marketing_images?.map(image => image.asset),
        ...
        video_ad_bumper_companion_banner_asset: ad.video_ad.bumper.companion_banner.asset,
        ...
        video_responsive_ad_companion_banners_asset: ad.video_responsive_ad.companion_banners.map(banner => banner.asset),
