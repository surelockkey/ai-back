...
export class GoogleAdsApiService {
  ...
  public getAD = async (customer_id = process.env.GOOGLE_ADS_CUSTOMER_ID): Promise<AdDto[]> => {
    ...
    return response.map(({ ad }) => ({
      ...
      app_ad_html5_media_bundles: ad?.app_ad?.html5_media_bundles,
      app_ad_images: ad?.app_ad?.images?.map(item => item.asset),
      app_ad_mandatory_ad_text: ad?.app_ad?.mandatory_ad_text,
      ...
      app_pre_registration_ad_youtube_videos: ad?.app_pre_registration_ad?.youtube_videos,
      ...
      demand_gen_carousel_ad_description: ad?.demand_gen_carousel_ad?.description,
      demand_gen_carousel_ad_headline: ad?.demand_gen_carousel_ad?.headline,
      demand_gen_carousel_ad_logo_image: ad?.demand_gen_carousel_ad?.logo_image,
      ...
      demand_gen_product_ad_business_name: ad?.demand_gen_product_ad?.business_name,
      demand_gen_product_ad_call_to_action: ad?.demand_gen_product_ad?.call_to_action,
      demand_gen_product_ad_description: ad?.demand_gen_product_ad?.description,
      demand_gen_product_ad_headline: ad?.demand_gen_product_ad?.headline,
      demand_gen_product_ad_logo_image: ad?.demand_gen_product_ad?.logo_image,
      ...
      demand_gen_video_responsive_ad_business_name: ad?.demand_gen_video_responsive_ad?.business_name,
      demand_gen_video_responsive_ad_call_to_actions: ad?.demand_gen_video_responsive_ad?.call_to_actions?.map(item => item.asset),
      demand_gen_video_responsive_ad_descriptions: ad?.demand_gen_video_responsive_ad?.descriptions,
      ...
      display_upload_ad_display_upload_product_type: ad?.display_upload_ad?.display_upload_product_type,
      display_upload_ad_media_bundle: ad?.display_upload_ad?.media_bundle,
      ...
      final_app_urls: ad?.final_app_urls,
      ...
      image_ad_mime_type: ad?.image_ad?.mime_type,
      ...
      legacy_app_install_ad: ad?.legacy_app_install_ad,
      ...
      legacy_responsive_display_ad_format_setting: ad?.legacy_responsive_display_ad?.format_setting,
      ...
      local_ad_descriptions: ad?.local_ad?.descriptions,
      local_ad_headlines: ad?.local_ad?.headlines,
      local_ad_logo_images: ad?.local_ad?.logo_images,
      ...
      responsive_display_ad_long_headline: ad?.responsive_display_ad?.long_headline,
