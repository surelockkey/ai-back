  ...
  public getGroups = async (customer_id = process.env.GOOGLE_ADS_CUSTOMER_ID): Promise<AdGroupDto[]> => {
    ...
    try {
      ...
      return response.map(({ ad_group, campaign, metrics, segments }) => ({
        ...
        segments_ad_destination_type: segments.ad_destination_type,
        segments_ad_format_type: segments.ad_format_type,
        segments_ad_network_type: segments.ad_network_type,
        ...
        segments_click_type: segments.click_type,
        segments_conversion_action: segments.conversion_action,
        segments_conversion_action_category: segments.conversion_action_category,
        ...
        segments_conversion_attribution_event_type: segments.conversion_attribution_event_type,
        segments_conversion_lag_bucket: segments.conversion_lag_bucket,
        segments_conversion_or_adjustment_lag_bucket: segments.conversion_or_adjustment_lag_bucket,
        segments_date: segments.date,
        segments_day_of_week: segments.day_of_week,
        segments_device: segments.device,
        segments_external_activity_id: segments.external_activity_id,
        segments_external_conversion_source: segments.external_conversion_source,
        ...
        segments_hotel_check_in_day_of_week: segments.hotel_check_in_day_of_week,
        ...
        segments_hotel_date_selection_type: segments.hotel_date_selection_type,
        segments_hotel_length_of_stay: segments.hotel_length_of_stay,
        segments_hotel_price_bucket: segments.hotel_price_bucket,
        segments_hotel_rate_rule_id: segments.hotel_rate_rule_id,
        segments_hotel_rate_type: segments.hotel_rate_type,
        ...
        segments_month_of_year: segments.month_of_year,
        segments_new_versus_returning_customers: segments.new_versus_returning_customers,
        segments_partner_hotel_id: segments.partner_hotel_id,
        segments_placeholder_type: segments.placeholder_type,
        ...
        segments_product_channel: segments.product_channel,
        segments_product_channel_exclusivity: segments.product_channel_exclusivity,
        segments_product_condition: segments.product_condition,
        ...
        segments_search_engine_results_page_type: segments.search_engine_results_page_type,
        segments_slot: segments.slot,
