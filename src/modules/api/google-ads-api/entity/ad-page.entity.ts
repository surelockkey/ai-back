...
export class AdPage {
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.CallConversionReportingState),
    default: null,
  })
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.DisplayUploadProductType),
    default: null,
  })
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.MediaType),
    default: null,
  })
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.MimeType),
    default: null,
  })
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.DisplayAdFormatSetting),
    default: null,
  })
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.SystemManagedResourceSource),
    default: null,
  })
  ...
  @Column({
    type: 'enum',
    nullable: true,
    enum: prepareEnum(enums.VideoThumbnail),
    default: null,
  })
